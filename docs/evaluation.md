...
The rule set was expanded after an initial test review. Results are exploratory and require a prospectively frozen policy plus fresh data or an online experiment before deployment. Full audit evidence is in the [evaluation audit](../reports/audit/evaluation_audit.md).
